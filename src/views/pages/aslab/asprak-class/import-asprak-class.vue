    ...
    <div class="col-sm-12 col-md-12">
      ...
      <div>
        ...
        >
          ...
          >
            - Pastikan NIM yang digunakan tersedia di <a href="/aslab/student"><b>Data Praktikan</b></a>,<br>
            - Pastikan kode mata kuliah yang digunakan tersedia di 
            <a
              v-b-tooltip.hover
              title="Hubungi Laboran"
              href="javascript:void(0);"
            ><b>Kelas Mata Kuliah</b></a>,<br>
          ...
          <img
            class="mt-2 mb-2"
            src="@/assets/images/asprak-excel-example.png"
          ...
          <div class="mb-4 mt-4">
            ...
            >
              Contoh file Excel: <a
                href="/files/asprakdummy.xlsx"
                download
              >asprakdummy.xlsx</a><br>
            </p>
          </div>
          <!-- file upload -->
          <vue-dropzone
