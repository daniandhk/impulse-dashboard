  ...
  <Layout>
    ...
    <div>
      <form>
        ...
        <div
          v-if="isPretestSelected || isPosttestSelected"
          class="mb-4"
        >
          <h4 class="card-title">
            Multiple Choices
          ...
          <div
            v-for="(question, index) in dataTest.question"
            :key="index"
            class="col-sm-12"
          >
            <div class="row">
              <div class="text-center col-sm-1">
                ...
                <b-button 
                  ...
                  style="min-width: 75px;" 
                  variant="danger"
                  @click="removeMultiple(dataTest.question, index)"
                >
                  remove
                </b-button>
              </div>
          ...
          <div class="text-center">
            <b-button
              variant="secondary"
              @click="addMultiple(dataTest.question)"
            >
              Tambah Soal
            </b-button>
          </div>
