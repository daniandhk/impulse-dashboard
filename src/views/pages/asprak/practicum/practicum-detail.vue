...
export default {
  ...
  methods: {
    ...
    setId(id){
      ...
      this.urlJadwal = "/asprak/schedule/" + this.schedule_data.id ;
      this.urlSoal = "/asprak/schedule/" + this.schedule_data.id + "/create-test";
    },
    ...
    submitSchedule(type, status = null){
        if(this.isJadwalNull){
          Swal.fire("Jadwal belum diatur...", "Harap input jadwal di menu Edit Jadwal!", "error");
        }
        else{
          this.submitted = true;
          ...
          if(type=='pretest'){
              if(this.isPretestNull == false){
                ...
                Swal.fire("Soal Tes Awal kosong...", "Harap input soal di menu Input Soal!", "error");
              }
          }
          else if(type=='journal'){
              if(this.isJournalNull == false){
                ...
                Swal.fire("Soal Jurnal kosong...", "Harap input soal di menu Input Soal!", "error");
              }
          }
          else if(type=='posttest'){
              if(this.isPosttestNull == false){
                ...
                Swal.fire("Soal Tes Akhir kosong...", "Harap input soal di menu Input Soal!", "error");
              }
          }
        }
    },
                  ...
                  <div class="text-center form-group mb-0">
                    <div>
                      ...
                      <b-alert
                        ...
                        variant="danger"
                      >
                        Harap input jadwal di menu <a :href="urlJadwal"><b>Edit Jadwal</b></a>!
                      </b-alert>
                      <div class="row mt-4">
                        <div class="col-sm-5">
                          <input
