...
export default {
  ...
  data() {
    return {
      ...
      religionData: ['Islam', 'Kristen', 'Katolik', 'Buddha', 'Hindu', 'Other'],
                ...
                <div class="card mt-2" v-if="seen">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc" style="font-size: 14px; margin: 0 !important;">
                            ...
                            - Pastikan Header / Row ke 1 di dalam file sama seperti berikut ini:<br>
                            </p>
        ...
        <div title="Student Data">
            <div class="tab-pane" id="metadata">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="fullname">Kode Mata Kuliah</label>
                            <input 
                            v-model="dataStudent.name"
                            id="fullname" 
                            name="fullname" 
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="nim">Kelas Mata Kuliah</label>
                            <input
                                v-model="dataStudent.nim"
                                id="nim"
                                name="nim"
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                        <label class="control-label">Kode Dosen MK</label>
                        <multiselect
                            v-model="dataStudent.religion"
