...
export default {
  ...
  data() {
    return {
      title: "Staff Data",
      dataStaff: { name: "", nim: "", gender: "", religion: "" },
      kelas: "",
      submitted: false,
      inputError: null,
      tryingToInput: false,
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            v-model="dataStaff.nim"
                                            id="nim"
                                            name="nim"
                                            type="number"
                                            class="form-control"
                                            :class="{ 'is-invalid': submitted && $v.dataStaff.nim.$error }"
                                        />
                                        <div
                                        v-if="submitted && !$v.dataStaff.nim.required"
                                        class="invalid-feedback"
                                        >NIM is required.</div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <multiselect
                                        ...
                                        :options="['Male', 'Female']"
                                        :class="{ 'is-invalid': submitted && $v.dataStaff.gender.$error }" 
                                    ></multiselect>
                                        <div
                                        v-if="submitted && !$v.dataStaff.gender.required"
                                        class="invalid-feedback"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <multiselect
                                        v-model="dataStaff.religion"
                                        :options="['Islam', 'Kristen', 'Katolik', 'Buddha', 'Hindu', 'Other']"
                                        :class="{ 'is-invalid': submitted && $v.dataStaff.religion.$error }" 
                                    ></multiselect>
                                        <div
                                        v-if="submitted && !$v.dataStaff.religion.required"
                                        class="invalid-feedback"
