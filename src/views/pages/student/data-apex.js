...
const columnChart = {
    series: [{
        name: 'Tes Awal',
        data: [18, 5, 20, 20, 15, 10, 20, 20, 20, 20]
    }, {
        name: 'Jurnal',
        data: [30, 50, 45, 20, 45, 35, 50, 50, 40, 30]
    }, {
        name: 'Tes Akhir',
        data: [25, 30, 20, 20, 30, 30, 30, 10, 30, 30]
    },],/* {
        name: 'Total',
        data: [93, 65, 85, 80, 70, 90, 100, 50, 90]
    }, */
    chartOptions: {
        chart: {
            toolbar: {
        ...
        xaxis: {
            categories: ['Modul-1', 'Modul-2', 'Modul-3', 'Modul-4', 'Modul-5', 'Modul-6', 'Modul-7', 'Modul-8', 'Modul-9', 'Modul-10'],
        },
        yaxis: {
            title: {
                text: ' (poin)'
